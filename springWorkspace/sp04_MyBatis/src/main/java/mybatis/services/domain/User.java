package mybatis.services.domain;
...
public class User implements Serializable {
	...
	///Field
    private String userId; 			// 회원 ID // 컬럼명과 다름
    private String userName;		// 회원 이름  컬럼명과 다름
    private String password;     // 비밀번호 
    private Integer age;    			// 나이 :: Integer wrapper class 사용 :: 추후 용도 확인  
    private int grade;    				// 등급 :: int primitive 사용 :: :: 추후 용도 확인 
    private Timestamp regDate	= new Timestamp(new Date().getTime()); // 가입일자 컬럼명과 다름
