...
public class BankAppTest {
	...
	public static void main(String[] args) {
		...
		Customer ct1 = new Customer("미경",new Account(1,"미경", "부산은행"),"부산 연제구");
		Customer ct2 = new Customer("자경",new Account(2,"자경", "부산은행"),"부산 기장군");
		...
		System.out.println(ac1.getAccountInfo());
		System.out.println(ac2.getAccountInfo());
		sc.close();
